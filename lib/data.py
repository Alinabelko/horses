...
Prices = collections.namedtuple('Prices', field_names=['seconds_to_start', 'bet_type',
...
def prices_to_relative(prices):
    ...
    return Prices(seconds_to_start=prices.seconds_to_start, bet_type=prices.bet_type,
